PROJECT 2: Superstores Database

QUESTION 1- Describe the data in hand in your own words. 
* This superstore database contains Sales details of transaction of a superstore. 
* The structure has 5 tables.

Table 1) Cust_dimen (containing details about customer and their respective locations)
...
Table 2)  Prod_dimen (containing product category and their subcategories)

            Product_Category (TEXT): Product Category
        	Product_Sub_Category (TEXT): Product Sub Category
		    Prod_id (TEXT): Unique Product ID

Table 3)  Orders_dimen (with order no, date, and priority)
...
Table 4)  Shipping_dimen (with ship date, order and shipping mode)
...
Table 5)  market_fact (orderwise customerwise marketwise orderquantity, sales value, discount profit and shipping cost details).
...
QUESTION 2 - Identify and list the Primary Keys and Foreign Keys for this dataset provided to 
...
Task 2: Basics & Advance Analysis (Queries)
